module github.com/ProtoconNet/mitum-smart-contract

go 1.25.9

require (
	github.com/ProtoconNet/mitum-currency/v3 v3.0.0-alpha.0.20260528024047-8f088e2c2c04
	github.com/ProtoconNet/mitum2 v0.0.0-20251029064552-01636c528af3
